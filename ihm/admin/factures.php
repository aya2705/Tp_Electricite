                    ...
                    <div class="card-body">
                        <table class="data-table">
                            ...
                            <tbody>
                                <?php if (!empty($facturesAnnuelles)): ?>
                                    <?php foreach ($facturesAnnuelles as $facture): ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>FA-<?php echo str_pad($facture['facture_annuelle_id'], 6, '0', STR_PAD_LEFT); ?>
                                            </td>
                                            ...
                                            <td>
                                                <span
                                                    class="<?php echo $facture['type'] === 'credit' ? 'text-success' : 'text-danger'; ?>">
                                            ...
                                            <td>
                                                <span
                                                    class="badge <?php echo $facture['statut'] === 'emise' ? 'badge-warning' : ($facture['statut'] === 'payee' ? 'badge-success' : 'badge-danger'); ?>">
                                ...
                                <?php else: ?>
                                    <tr>
                                        <td colspan="11" class="text-center">Aucune facture annuelle disponible</td>
