...
<body>
    ...
    <script>
        ...
        document.addEventListener("DOMContentLoaded", function () {
            ...
            // Écouter l'événement de modification des filtres
            ...
            function applyFilters() {
                ...
                // Appliquez la logique de filtrage ici sur les réclamations
                // Utilisez `searchText`, `status` et `type` pour filtrer vos données
                // Par exemple : 
            ...
            // Actualiser les réclamations (retourner à la première page et recharger)
            document.getElementById('refresh-claims-btn').addEventListener('click', function () {
                applyFilters();
            });
        });
